...
void
initClk(void) __attribute__((always_inline));
void
delayus(unsigned long __t) __attribute__((always_inline));
void
delayms(unsigned long __t) __attribute__((always_inline));
