...
/* If the STM32 CMSIS device header is included, it will provide
   the IRQn_Type and all IRQ enumerators. Avoid redefinition conflicts
   by guarding our legacy IRQn definition. */
