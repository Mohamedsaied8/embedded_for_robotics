...
void
dma_channel_reset(uint32_t dma, u8 channel);
void
dma_enable_mem2mem_mode(uint32_t dma, u8 channel);
void
dma_set_priority(uint32_t dma, u8 channel, u32 prio);
void
dma_set_memory_size(uint32_t dma, u8 channel, u32 mem_size);
void
dma_set_peripheral_size(uint32_t dma, u8 channel, u32 peripheral_size);
void
dma_enable_memory_increment_mode(uint32_t dma, u8 channel);
void
dma_enable_peripheral_increment_mode(uint32_t dma, u8 channel);
void
dma_enable_circular_mode(uint32_t dma, u8 channel);
void
dma_set_read_from_peripheral(uint32_t dma, u8 channel);
void
dma_set_read_from_memory(uint32_t dma, u8 channel);
void
dma_enable_transfer_error_interrupt(uint32_t dma, u8 channel);
void
dma_disable_transfer_error_interrupt(uint32_t dma, u8 channel);
void
dma_enable_half_transfer_interrupt(u32 dma, u8 channel);
void
dma_disable_half_transfer_interrupt(u32 dma, u8 channel);
void
dma_enable_transfer_complete_interrupt(u32 dma, u8 channel);
void
dma_disable_transfer_complete_interrupt(u32 dma, u8 channel);
void
dma_enable_channel(u32 dma, u8 channel);
void
dma_disable_channel(u32 dma, u8 channel);
void
dma_set_peripheral_address(u32 dma, u8 channel, u32 address);
void
dma_set_memory_address(u32 dma, u8 channel, u32 address);
void
dma_set_number_of_data(u32 dma, u8 channel, u16 number);
