...
#define NO_REMAP 0
void
spi_reset(SPI_TypeDef *SPI);
int
spi_init_master(SPI_TypeDef *SPI, uint32_t br, uint32_t cpol, uint32_t cpha, uint32_t dff,
                uint32_t lsbfirst, uint8_t remap);
void
spi_enable(SPI_TypeDef *SPI);
void
spi_disable(SPI_TypeDef *SPI);
uint16_t
spi_clean_disable(SPI_TypeDef *SPI);
void
spi_write(SPI_TypeDef *SPI, uint16_t data);
void
spi_send(SPI_TypeDef *SPI, uint8_t data);
uint16_t
spi_read(SPI_TypeDef *SPI);
uint16_t
spi_xfer(SPI_TypeDef *SPI, uint16_t data);
void
spi_set_bidirectional_mode(SPI_TypeDef *SPI);
void
spi_set_unidirectional_mode(SPI_TypeDef *SPI);
void
spi_set_bidirectional_receive_only_mode(SPI_TypeDef *SPI);
void
spi_set_bidirectional_transmit_only_mode(SPI_TypeDef *SPI);
void
spi_enable_crc(SPI_TypeDef *SPI);
void
spi_disable_crc(SPI_TypeDef *SPI);
void
spi_set_next_tx_from_buffer(SPI_TypeDef *SPI);
void
spi_set_next_tx_from_crc(SPI_TypeDef *SPI);
void
spi_set_dff_8bit(SPI_TypeDef *SPI);
void
spi_set_dff_16bit(SPI_TypeDef *SPI);
void
spi_set_full_duplex_mode(SPI_TypeDef *SPI);
void
spi_set_receive_only_mode(SPI_TypeDef *SPI);
void
spi_disable_software_slave_management(SPI_TypeDef *SPI);
void
spi_enable_software_slave_management(SPI_TypeDef *SPI);
void
spi_set_nss_high(SPI_TypeDef *SPI);
void
spi_set_nss_low(SPI_TypeDef *SPI);
void
spi_send_lsb_first(SPI_TypeDef *SPI);
void
spi_send_msb_first(SPI_TypeDef *SPI);
void
spi_set_baudrate_prescaler(SPI_TypeDef *SPI, uint8_t baudrate);
void
spi_set_master_mode(SPI_TypeDef *SPI);
void
spi_set_slave_mode(SPI_TypeDef *SPI);
void
spi_set_clock_polarity_1(SPI_TypeDef *SPI);
void
spi_set_clock_polarity_0(SPI_TypeDef *SPI);
void
spi_set_clock_phase_1(SPI_TypeDef *SPI);
void
spi_set_clock_phase_0(SPI_TypeDef *SPI);
void
spi_enable_tx_buffer_empty_interrupt(SPI_TypeDef *SPI);
void
spi_disable_tx_buffer_empty_interrupt(SPI_TypeDef *SPI);
void
spi_enable_rx_buffer_not_empty_interrupt(SPI_TypeDef *SPI);
void
spi_disable_rx_buffer_not_empty_interrupt(SPI_TypeDef *SPI);
void
spi_enable_error_interrupt(SPI_TypeDef *SPI);
void
spi_disable_error_interrupt(SPI_TypeDef *SPI);
void
spi_enable_ss_output(SPI_TypeDef *SPI);
void
spi_disable_ss_output(SPI_TypeDef *SPI);
void
spi_enable_tx_dma(SPI_TypeDef *SPI);
void
spi_disable_tx_dma(SPI_TypeDef *SPI);
void
spi_enable_rx_dma(SPI_TypeDef *SPI);
void
spi_disable_rx_dma(SPI_TypeDef *SPI);
void
spi_set_standard_mode(SPI_TypeDef *SPI, uint8_t mode);
int
spi_dma_transceive(uint8_t *tx_buf, int tx_len, uint8_t *rx_buf, int rx_len);
int
spi2_dma_transceive(uint8_t *tx_buf, int tx_len, uint8_t *rx_buf, int rx_len);
void
spi1_dma_receive(uint8_t *rx_buf, int rx_len);
void
spi1_dma_transmit(uint8_t *tx_buf, int tx_len);
